      ...
      <div className="post-content">
        ...
        <div className="space-y-3">
          <p className="text-sm">
            ...
            molestias cum repellat possimus asperiores voluptate praesentium
            commodi accusantium aliquid.
          </p>
          <Image
          ...
          <div className="icon-list flex justify-between">
            <div className="left-icon flex gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <input
              className="input input-md w-full input-bordered join-item"
              placeholder="Email"
            />
